# Rinkyn Codes - Blog Demo Tema Oscuro - Sitio Web Básico - Estilo Blog - Creado Con HTML Y CSS 🌐


Este es un proyecto sencillo de un sitio web estilo blog con un tema oscuro, creado únicamente con **HTML** y **CSS**. El objetivo principal es aprender y practicar las bases de desarrollo web, diseñando una estructura organizada y funcional sin depender de frameworks o librerías externas.
